...
\noindent Добавить в список игнорируемых файлов: \\
\indent\texttt{\$git config {-}-global core.excludesFile '\~{}/.gitignore'} \\
\noindent Сохранять учетные данные при регистрации на удаленных сервисах: \\
\indent\texttt{\$git config {-}-global credential.helper store}
