...
\begin{document}
	...
	\begin{itemize}
		...
		\item \href{https://losst.pro/nastrojka-seti-netplan-v-ubuntu}{Настройка сети Netplan в Ubuntu}
		\item \href{https://netplan.readthedocs.io/en/stable/netplan-yaml/}{YAML configuration - Netplan documentation}
		\item \href{https://www.dmosk.ru/miniinstruktions.php?mini=network-netplan}{Настройка сети в Linux с помощью netplan}
	\end{itemize}
