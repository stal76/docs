...
\noindent Варианты значений тэгов:\\
\indent latest, <version>, alpine (минимального размера) \\

\ccn{\$docker save <image>}{Сохранить image в tar архив}
\ccn{\$docker load}{Загрузить image из tar архива или через stdin}
